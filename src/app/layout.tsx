...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://res.cloudinary.com/dn8c5398m/image/upload/q_auto/f_auto/v1781607525/hk_logo_iets_groter_tumykq.png', width: 1200, height: 630, alt: 'Honkbal Hoofdklasse' }],
  },
  twitter: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${barlowCondensed.variable} ${inter.variable}`}>
      <head>
        <link rel="apple-touch-icon" href="https://res.cloudinary.com/dn8c5398m/image/upload/q_auto,w_180,h_180,c_fill/f_auto/v1781608197/APP_LOGO_juysrd.png" />
