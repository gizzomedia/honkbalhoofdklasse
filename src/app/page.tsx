...
async function getData() {
  ...
  const [standRes, resultsRes, upcomingRes, mediaRes, news, leaders, highlights] = await Promise.all([
...
export default async function HomePage() {
  const { standings, results, upcoming, media, news, leaders, highlights } = await getData()
