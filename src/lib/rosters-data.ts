...
export const ROSTERS: StaticRosters = {
  pirates: {
    players: [
      { uniform: '84', name: 'Mihai Bracacescu',     pos: 'C',  bt: 'R/R', yob: 2005 },
      { uniform: '7',  name: 'Dennis Burgersdijk',   pos: 'P',  bt: 'R/R', yob: 1988 },
      { uniform: '53', name: 'Quintin De Cuba',       pos: 'IF', bt: 'L/R', yob: 1987 },
      { uniform: '9',  name: 'Victor Draijer',        pos: 'OF', bt: 'R/R', yob: 1993 },
      { uniform: '31', name: 'Julian Goins',          pos: 'C',  bt: 'R/R', yob: 1994 },
      { uniform: '92', name: 'Daan Hijzelendoorn',    pos: 'P',  bt: 'R/R', yob: 2007 },
      { uniform: '39', name: 'Lars Huijer',           pos: 'P',  bt: 'R/R', yob: 1993 },
      { uniform: '1',  name: 'Jason Jakobus',         pos: 'OF', bt: 'R/R', yob: 1986 },
      { uniform: '51', name: 'Sedley Karel',          pos: 'P',  bt: 'R/R', yob: 1990 },
      { uniform: '72', name: 'Yassir Lachkar',        pos: 'P',  bt: 'R/R', yob: 2001 },
      { uniform: '13', name: 'Alex Madera',           pos: 'IF', bt: 'R/R', yob: 1997 },
      { uniform: '16', name: 'Brendly Martina',       pos: 'IF', bt: 'R/R', yob: 1996 },
      { uniform: '4',  name: 'Junior Martina',        pos: 'IF', bt: 'R/R', yob: 1997 },
      { uniform: '65', name: 'Thibaud Pastor',        pos: 'IF', bt: 'R/R', yob: 2005 },
      { uniform: '28', name: 'Jorrit Penseel',        pos: 'IF', bt: 'R/R', yob: 2000 },
      { uniform: '48', name: 'Connor Prins',          pos: 'P',  bt: 'R/R', yob: 2003 },
      { uniform: '17', name: 'Danyll Redan',          pos: 'P',  bt: 'R/R', yob: 2008 },
      { uniform: '3',  name: 'Martijn Schoonderwoerd',pos: 'P',  bt: 'R/R', yob: 1997 },
      { uniform: '6',  name: 'Delano Selassa',        pos: 'IF', bt: 'R/R', yob: 1999 },
      { uniform: '32', name: 'Jeandro Tromp',         pos: 'OF', bt: 'L/R', yob: 2000 },
      { uniform: '23', name: 'Tommy Van De Sanden',   pos: 'OF', bt: 'R/R', yob: 1999 },
      { uniform: '25', name: 'Pim Vijfvinkel',        pos: 'P',  bt: 'R/R', yob: 2001 },
    ],
    coaches: [
